...
X=[data['char_to_ind'][char] for char in data['book_data'][:len(data['book_data'])-2]]
Y=[data['char_to_ind'][char] for char in data['book_data'][1:len(data['book_data'])-1]]
# X=[data['char_to_ind'][char] for char in data['book_data'][:25]]
# Y=[data['char_to_ind'][char] for char in data['book_data'][1:26]]
rnn.train(X,Y)
rnn.getText(rnn.prevH,data['char_to_ind']['h'] , 1000)
